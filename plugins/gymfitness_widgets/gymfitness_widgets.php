...
/*
    ...
    Plugin URI:
    Description: Añade widgets para los custom post types al sitio Gym Fitness
    Version: 1.0.0
    Author: Matias Duran
    Author URI: 
    Text Domain:
        ...
        <ul>
            ...
            ?>
                <li class="clase-sidebar">
                    <div class="imagen"><?php the_post_thumbnail('thumbnail'); ?></div>

                    <div class="contenido-clase">
                        <a href="<?php the_permalink(); ?>">
                            <h3 class="texto-primario">
                                <?php the_title(); ?>
                            </h3>
                        </a>

                        <p>
                            <?php the_field('dias_de_clase') ?> - <?php the_field('hora_inicio'); ?> a <?php the_field('hora_fin'); ?>
                        </p>
                    </div>
                </li>
            <?php
...
function gymFitness_registrar_widgets()
{
    register_widget('GymFitness_clases_Widgets');
}
add_action('widgets_init', 'gymFitness_registrar_widgets');
